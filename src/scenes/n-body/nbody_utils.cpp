...
void initParticles() {
  constexpr uint32_t patricles_per_attractor = 4 * 1024;
  constexpr uint32_t attractorsSize = 6;
  ...
  Particle particleBuffer[patricles_per_attractor * attractorsSize];
  ...
  for (uint32_t i = 0; i < attractorsSize; i++) {
    Particle &particle = particleBuffer[i * patricles_per_attractor];
  ...
  for (uint32_t i = 0; i < attractorsSize; i++) {
    for (uint32_t j = 1; j < patricles_per_attractor; j++) {
      Particle &particle = particleBuffer[i * patricles_per_attractor + j];
